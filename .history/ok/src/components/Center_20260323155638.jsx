      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center text-center">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Paragraph */}
            <p className="text-base md:text-lg lg:text-xl text-gray-200 mb-10 leading-relaxed max-w-2xl mx-auto">
              Experience innovation like never before. Join us on an extraordinary 
              journey where technology meets creativity, and possibilities become reality.

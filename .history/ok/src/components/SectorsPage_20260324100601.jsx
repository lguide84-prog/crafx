...
const SectorsPage = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-12 md:py-20 px-4">
      <div className="container mx-auto">
        ...
        <div 
          className="relative mt-12 md:mt-24 rounded-2xl md:rounded-3xl overflow-hidden fade-up-element"
          id="cta"
          style={{
        ...
        >
          <div style={{ backgroundColor: "#18403C" }} className="relative rounded-2xl md:rounded-3xl overflow-hidden">
            {/* Animated Background Pattern */}
            <div className="absolute inset-0 opacity-10">
              <div className="absolute top-0 left-0 w-32 h-32 md:w-64 md:h-64 bg-white rounded-full blur-3xl animate-pulse"></div>
              <div className="absolute bottom-0 right-0 w-48 h-48 md:w-96 md:h-96 bg-white rounded-full blur-3xl animate-pulse delay-1000"></div>
            </div>
            
            <div className="relative p-6 md:p-12 lg:p-16 text-center">
              <h3 className="text-2xl md:text-4xl lg:text-5xl font-bold text-white mb-3 md:mb-4">
                Ready to Transform Your Workforce?
              </h3>
              <p className="text-white/90 text-sm md:text-base lg:text-lg mb-6 md:mb-8 max-w-2xl mx-auto px-2">
                Join 500+ satisfied clients who have revolutionized their staffing strategies with our expert solutions
              </p>
              
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center px-4">
                <button className="group bg-white px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold transition-all duration-300 hover:scale-105 shadow-lg flex items-center gap-2 justify-center text-sm md:text-base" style={{ color: "#18403C" }}>
                  Get in Touch Today
                  <FaArrowRight className="text-xs md:text-sm group-hover:translate-x-1 transition-transform duration-300" />
                </button>
                <button className="border-2 border-white text-white px-6 md:px-8 py-2 md:py-3 rounded-full font-semibold transition-all duration-300 hover:bg-white hover:text-[#18403C] text-sm md:text-base">

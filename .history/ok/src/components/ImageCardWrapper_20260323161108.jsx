...
const SplitPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 park">
      <div className="flex flex-col md:flex-row min-h-screen">
        
        {/* Left Section - 30% Width */}
        <div className="w-full md:w-[30%] bg-gradient-to-br from-indigo-600 to-indigo-800 text-white p-8  flex flex-col justify-center">
          {/* Heading */}
          ...
          {/* Button */}
          <button className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-white text-indigo-600 font-semibold rounded-lg hover:bg-indigo-50 transition duration-300 transform hover:scale-105 shadow-lg w-fit group">
        ...
        <div className="w-full md:w-[70%] flex flex-col">
          ...
          <div className="h-[20%] bg-white border-b border-gray-200 px-6 md:px-8 lg:px-12 flex items-center">

           ...
           Take the first step toward building your dream team.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
             ...
             <img src="/images/ok.svg"/>
              ...
              <button className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-transparent border-2 border-white hover:bg-[#1F514C] hover:text-white text-white font-semibold rounded-lg transition duration-300 transform hover:scale-105 group">
                <svg

  ...
  const features = [
    {
      ...
      icon: (
        <svg
          className="w-12 h-12 text-[#1F514C]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
  ...
  return (
    <div className="min-h-screen bg-white py-16 md:py-24 park">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
         <h1 className="bg-gray-400 rounded-2xl text-center w-fit">Our Benefits</h1>
        {/* Centered Heading and Paragraph */}
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
         
          <h1 className="text-3xl md:text-3xl lg:text-4xl font-medium text-[#1F514C] mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
          {features.map((feature) => (
            ...
            >
              ...
              {/* Content */}
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-3 group-hover:text-[#1F514C] transition-colors">
                  {feature.title}
                </h3>

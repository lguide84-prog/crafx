      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center text-center park">
        <div className="container mx-auto px-6 md:px-12 lg:px-20">
          <div className="max-w-2xl mx-auto">
            {/* Heading */}
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-white mb-6 leading-tight animate-fade-in">
           Take the first step toward building your dream team.
            </h1>

            {/* Paragraph */}
            <p className="text-base md:text-lg lg:text-sm text-gray-200 mb-10 leading-relaxed max-w-2xl mx-auto">

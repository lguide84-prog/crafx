        ...
        <div className="container mx-auto px-6 ">
          <div className="max-w-2xl">
            ...
            {/* Buttons */}
              ...
              <button className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-indigo-600 hover:bg-indigo-700 text-[#1F514C] font-semibold rounded-lg transition duration-300 transform hover:scale-105 shadow-lg group">

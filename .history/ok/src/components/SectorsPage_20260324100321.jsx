  ...
  return (
    <div className="bg-gradient-to-b from-white to-gray-50 min-h-screen py-20 px-4">
      <div className="container mx-auto">
        ...
        <div 
          className="text-center mb-20 fade-up-element" 
          id="header"
          style={{
        ...
        <div 
          className="relative mt-24 rounded-3xl overflow-hidden fade-up-element"
          id="cta"
          style={{
        ...
        >
          <div style={{ backgroundColor: "#18403C" }} className="relative rounded-3xl overflow-hidden">

    ...
    <div className="min-h-screen bg-[#1F514C] park">
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-[35%] bg-[#1F514C] text-white p-4  flex flex-col justify-center">
          ...
          {/* Button */}
          <button className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-white text-[] font-semibold rounded-lg hover:bg-indigo-50 transition duration-300 transform hover:scale-105 shadow-lg w-fit group">

    ...
    <div className="min-h-screen bg-[#1F514C] park">
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="w-full md:w-[35%] bg-[#1F514C] text-white p-4  flex flex-col justify-center">
          ...
          {/* Paragraph */}
          <p className="text-base md:text-md text-indigo-100 mb-8 leading-relaxed">
        ...
        <div className="w-full md:w-[65%] flex flex-col">
          ...
          <div className="h-[20%] bg-[#1F514C] border-b border-[#1F514C] px-6 md:px-8 lg:px-12 flex items-center">
          ...
          <div className="h-[80%] bg-[#1F514C] p-6 md:p-8 lg:p-12 overflow-auto">
            <div className="bg-[#35625D] border-1 border rounded-2xl shadow-xl overflow-hidden h-full">
                ...
                <div className="w-full lg:w-[60%] p-6 md:p-8">
                  ...
                  <div className="space-y-3 ">
                    <div className="flex items-start gap-3">
                      ...
                      <span className="text-gray-700">Better Talent Fit</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-indigo-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-700">Enhanced Hiring Quality</span>
                    </div>
                    <div className="flex items-start gap-3">
                      <svg className="w-6 h-6 text-indigo-600 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-gray-700">Reduced Turnover</span>
                    </div>
